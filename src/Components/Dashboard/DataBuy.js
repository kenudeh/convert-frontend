...
const DataBuy = () => {
    ...
    const validateForm = () => {
        const {phone_number, amount, data_volume} = formData;
        ...
        // Validate amount (must not exceed 6 digits)
        if (data_volume.length > 100 || isNaN(amount)) {
            setMessage('Data volume must not exceed 100GB');
            setIsError(true);
            return false;
        }
            ...
            <article className='main-content'>
                ...
                <section className='content'>
                    <section className='intro'>
                        <p>Submit a data purchase request</p>
                        <section className='balance'>
                            <p>Balance: ₦0.00</p>
                        </section>
                    </section>
                            ...
                            <div className="success-dialog">
                                ...
                                {transactionDetails && (
                                    <div className="transaction-details">
                                        ...
                                        <p><strong>Data Volume:</strong> {transactionDetails.data_volume}</p>
                                    </div>
                                )}
